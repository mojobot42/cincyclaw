    ...
    <div className="app">
      <div className="hero">
        <nav className="nav">
          <div className="logo">
            ...
            <span className="logo-text">CincyClaw</span>
          </div>
          <div className="nav-badge">Powered by OpenClaw + NVIDIA NemoClaw</div>
        </nav>

        <div className="hero-content">
          <div className="hero-tag">AI Agents for Cincinnati Businesses</div>
          <h1>
      ...
      <section className="why-section">
        <div className="why-content">
          <h2>Why Cincinnati?</h2>
          <p>
            The world's biggest companies are racing to deploy AI agents. But most 
            businesses in Cincinnati don't have a Silicon Valley budget — or need one.
          </p>
          <p>
            We're local. We speak your language. We know that a dental office in Hyde Park 
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-brand">
            <span className="logo-icon">🦀</span> CincyClaw
          </div>
          <p>AI agents for Cincinnati businesses.</p>
          <p className="footer-copy">© 2026 CincyClaw. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
