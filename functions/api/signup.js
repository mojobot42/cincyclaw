      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
            ...
            <p>Hi there,</p>
            <p>Thank you for signing up — we're thrilled to have you. You're among the first to explore what AI agents can do for Cincinnati businesses, and our team is looking forward to connecting with you.</p>
            ...
            <p>We're excited to show you what's possible.<br><br>Warm regards,<br><strong>The CincyClaw Team</strong></p>
